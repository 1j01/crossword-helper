...
def find_superpuzzitions(target_length: int, target_patterns: list[re.Pattern], target_position: int | None = None, exactly_one_different=False) -> list[tuple[str, str, float]]:
	"""
